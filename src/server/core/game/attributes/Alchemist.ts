...
export class Alchemist extends BaseAttribute implements IAttribute {
  ...
  public oocAbility(player: Player): string {
    ...
    if(shouldTakeXP) {
      ...
      if(xpTaken === 0) return 'The experiment was a failure; there is no experience to be taken.';
    ...
    if(goldTaken === 0) return 'The experiment was a failure; there is no gold to be taken.';

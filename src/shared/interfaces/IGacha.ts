...
export const GachaNameReward: { [key in GachaReward]: string } = {
  ...
  [GachaReward.CrystalGreen]: 'Crystal (Green)',
  [GachaReward.CrystalYellow]: 'Crystal (Yellow)',
  [GachaReward.CrystalRed]: 'Crystal (Red)',
  [GachaReward.CrystalBlue]: 'Crystal (Blue)',
  [GachaReward.CrystalPurple]: 'Crystal (Purple)',
  [GachaReward.CrystalOrange]: 'Crystal (Orange)',
  [GachaReward.CrystalAstral]: 'Crystal (Astral)',

  [GachaReward.CrystalGreen5]: 'Crystal (Green x5)',
  [GachaReward.CrystalYellow5]: 'Crystal (Yellow x5)',
  [GachaReward.CrystalRed5]: 'Crystal (Red x5)',
  [GachaReward.CrystalBlue5]: 'Crystal (Blue x5)',
  [GachaReward.CrystalPurple5]: 'Crystal (Purple x5)',
  [GachaReward.CrystalOrange5]: 'Crystal (Orange x5)',
  [GachaReward.CrystalAstral5]: 'Crystal (Astral x5)',

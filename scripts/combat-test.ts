...
const characters: ICombatCharacter[] = [
  { combatId: 1, combatPartyId: 1, name: 'Watch My Stuff',
    ...
    level: 10,
    specialName: 'Minion',
    stats: { str: 500, dex: 100, con: 100, int: 100, agi: 50, luk: 100, hp: 10000, special: 0, gold: 10, xp: 10 },
    maxStats: { str: 500, dex: 100, con: 100, int: 100, agi: 50, luk: 100, hp: 10000, special: 3, gold: 10, xp: 10 }
  },
